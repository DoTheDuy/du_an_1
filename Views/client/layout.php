...
<div class="container">
    <header>
        <div class="alert alert-success " chuc_nang="alert">
            <h2 class="text-center">EDUMAN </h2>
        </div>
    </header>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/du_an_1?page=product">Khóa học</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/du_an_1?page=cart">Giỏ hàng</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/du_an_1?page=introduce">Giới thiệu</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/du_an_1?page=contact">Liên hệ</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/du_an_1?page=feedback">Góp ý</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/du_an_1?page=hoidap">Hỏi đáp</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row row-cols-2 g-col-20">
            ...
            <div class="col-3">
                <div class="account rounded">
                    <h4 class="alert alert-secondary" chuc_nang="alert">
                        Tài khoản
                    </h4>
                    <?php
                ...
                <div class="category rounded">
                    <h4 class="alert alert-secondary m-0" chuc_nang="alert">
                        Danh mục
                    </h4>
                    <div class="list-group">
                        <?php foreach ($loai_khoa_hoc as $key => $value) { ?>
                            <a href="/du_an_1?page=product&category=<?php echo $value['ma_loai'];?>" class="list-group-item list-group-item-action"><?php echo $value['ten_loai'];?></a>
                        <?php } ?>
                    </div>
                </div>
                    ...
                    <div class="card w-100">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex">
                                <a
                                    href="/du_an_1?page=detail&idPro=<?php echo $value['id']; ?>"
