...
<!-- Mirrored from themepure.net/html/eduman-prv/eduman/zoom-class.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Nov 2022 13:00:50 GMT -->
<head>
   <meta charset="utf-8">
...
<![endif]-->
               ...
               <div class="row align-items-center">
                  <div class="col-xl-8 col-lg-8">
                     <div class="header-top-icon">
                        ...
                        <a href="https://themepure.net/cdn-cgi/l/email-protection#f79e999198b7928f969a879b92d994989a"><i class="fal fa-envelope"></i><span class="__cf_email__" data-cfemail="3d54535b527d58455c504d5158135e5250">[email&#160;protected]</span></a>
                                    ...
                                    <ul>
                                       <li class="item-has-children"><a href="course.php">Development</a>
                                          <!-- <ul class="category-submenu">
                                             <li><a href="course.php">All Development</a></li>
                                             <li><a href="course.php">Mobile App</a></li>
                                             <li><a href="course.php">Web Development</a></li>
                                             <li><a href="course.php">Development tools</a></li>
                                             <li><a href="course.php">Database</a></li>
                                             <li><a href="course.php">Programming language</a></li>
                                          </ul> -->
                                       </li>
                                       <li class="item-has-children"><a href="course.php">Art & Design</a>
                                          <!-- <ul class="category-submenu">
                                             <li><a href="course.php">Web Design</a></li>
                                             <li><a href="course.php">Graphic Design</a></li>
                                             <li><a href="course.php">Design tools</a></li>
                                             <li><a href="course.php">All Art</a></li>
                                             <li><a href="course.php">Marketing</a></li>
                                          </ul> -->
                                       </li>
                                       <li class="item-has-children"><a href="course.php">Business</a>
                                          <!-- <ul class="category-submenu">
                                             <li><a href="course.php">All Business</a></li>
                                             <li><a href="course.php">Communications</a></li>
                                             <li><a href="course.php">Finance</a></li>
                                             <li><a href="course.php">Management</a></li>
                                             <li><a href="course.php">Sales</a></li>
                                          </ul> -->
                                       </li>
                                       <li class="item-has-children"><a href="course.php">Life Style</a>
                                          <!-- <ul class="category-submenu">
                                             <li><a href="course.php">Life Style</a></li>
                                             <li><a href="course.php">Mental Health</a></li>
                                             <li><a href="course.php">Dieting</a></li>
                                             <li><a href="course.php">All Art</a></li>
                                             <li><a href="course.php">Nutrition</a></li>
                                          </ul> -->
                                       </li>
                                       <li class="item-has-children"><a href="course.php">Health & Fitness</a>
                                          <!-- <ul class="category-submenu">
                                             <li><a href="course.php">All Health & Fitness</a></li>
                                             <li><a href="course.php">Beauty & Makeup</a></li>
                                             <li><a href="course.php">Food & Beverages</a></li>
                                             <li><a href="course.php">Good Food</a></li>
                                          </ul> -->
                                       </li>
                              ...
                              <ul>
                                 ...
                                 <li class="menu-item-has-children"><a href="#!">Pages</a>
                                    <ul class="sub-menu">
                                       ...
                                       <li class="menu-item-has-children"><a href="instructor.php">instructor</a>
                                          <!-- <ul class="sub-menu">
   ...
   <main>
            ...
            <div class="row">
               <div class="col-xl-12">
                  <div class="hero-course-1-text">
                     <h2>Zoom Live Class</h2>
                  </div>
                  <div class="course-title-breadcrumb">
                     <nav>
                        <ol class="breadcrumb">
                           <li class="breadcrumb-item"><a href="footer.php">Home</a></li>
                           <li class="breadcrumb-item"><span>Zoom Live Class</span></li>
                        </ol>
                     </nav>
                  </div>
               </div>
      ...
      <!-- zoom-class-area-start -->
      <section class="zoom-class-area pt-120 pb-90">
         <div class="container">
            <div class="row">
               <div class="col-xl-8 col-lg-8 col-md-12">
                  <div class="zoom-class-main-wrapper mb-30">
                     ...
                     <div class="zoom-class-item">
                        <div class="zooom-class-tittle">
                           <h3><a href="zoom-class-detalis.html">Startup Business Management
                                 Live Class</a></h3>
                        </div>
                        <div class="xzoom-class-detalis">
                           <div class="class-list-date d-flex align-items-center">
                              <i class="flaticon-calendar"></i><span>Date : 10 Jan 2022</span>
                           </div>
                           <div class="class-list-length d-flex align-items-center">
                              <i class="flaticon-video-marketing"></i><span>Length : 3h 20m</span>
                           </div>
                           <div class="class-list-time d-flex align-items-center">
                              <i class="flaticon-wall-clock"></i><span>Schedule : 10 AM - 12 PM</span>
                           </div>
                  ...
                  <div class="zoom-class-main-wrapper mb-30">
                     ...
                     <div class="zoom-class-item">
                        <div class="zooom-class-tittle">
                           <h3><a href="zoom-class-detalis.html">WordPress Theme Development
                                 Live Class</a></h3>
                        </div>
                        <div class="xzoom-class-detalis">
                           <div class="class-list-date d-flex align-items-center">
                              <i class="flaticon-calendar"></i><span>Date : 11 Jan 2022</span>
                           </div>
                           <div class="class-list-length d-flex align-items-center">
                              <i class="flaticon-video-marketing"></i><span>Length : 3h 20m</span>
                           </div>
                           <div class="class-list-time d-flex align-items-center">
                              <i class="flaticon-wall-clock"></i><span>Schedule : 9 AM - 12:45 PM</span>
                           </div>
                           <div class="class-metting">
                  ...
                  <div class="zoom-class-main-wrapper mb-30">
                     ...
                     <div class="zoom-class-item">
                        <div class="zooom-class-tittle">
                           <h3><a href="zoom-class-detalis.html">Write Better Emails: Tactics for
                                 Smarter Team Live Classs</a></h3>
                        </div>
                        <div class="xzoom-class-detalis">
                           <div class="class-list-date d-flex align-items-center">
                              <i class="flaticon-calendar"></i><span>Date : 11 Jan 2022</span>
                           ...
                           <div class="class-list-length d-flex align-items-center">
                              <i class="flaticon-video-marketing"></i><span>Length : 2h 20m</span>
                           </div>
                           <div class="class-list-time d-flex align-items-center">
                              <i class="flaticon-wall-clock"></i><span>Schedule : 11 AM - 12:45 PM</span>
                           </div>
                           <div class="class-metting">
                  ...
                  <div class="zoom-class-main-wrapper mb-30">
                     ...
                     <div class="zoom-class-item">
                        <div class="zooom-class-tittle">
                           <h3><a href="zoom-class-detalis.html">Self Entrepreneurship Essentials
                                 Live Class</a></h3>
                        </div>
                        <div class="xzoom-class-detalis">
                           <div class="class-list-date d-flex align-items-center">
                              <i class="flaticon-calendar"></i><span>Date : 20 Jan 2022</span>
                           </div>
                           <div class="class-list-length d-flex align-items-center">
                              <i class="flaticon-video-marketing"></i><span>Length : 1h 20m</span>
                           </div>
                           <div class="class-list-time d-flex align-items-center">
                              <i class="flaticon-wall-clock"></i><span>Schedule : 8 AM - 10:45 PM</span>
                           </div>
                           <div class="class-metting">
                  ...
                  <div class="zoom-class-main-wrapper mb-30">
                     ...
                     <div class="zoom-class-item">
                        <div class="zooom-class-tittle">
                           <h3><a href="zoom-class-detalis.html">Python and Django Full Stack
                                 Bootcamp Live Class</a></h3>
                        </div>
                        <div class="xzoom-class-detalis">
                           <div class="class-list-date d-flex align-items-center">
                              <i class="flaticon-calendar"></i><span>Date : 15 Jan 2022</span>
                           </div>
                           <div class="class-list-length d-flex align-items-center">
                              <i class="flaticon-video-marketing"></i><span>Length : 1h 20m</span>
                           </div>
                  ...
                  <div class="sidebar-widget-wrapper">
                     <div class="sidebar-widget mb-30">
                        <div class="sidebar-widget-inner">
                           <div class="sidebar-widget-head mb-25">
                              <h3>Find Class</h3>
                           </div>
                           <div class="sidebar-content">
                              <div class="myCalendar edu-calender">
                              </div>
                           </div>
                        </div>
                     </div>
...
<!-- Mirrored from themepure.net/html/eduman-prv/eduman/zoom-class.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Nov 2022 13:00:51 GMT -->
</html>