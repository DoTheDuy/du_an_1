...
<!-- Mirrored from themepure.net/html/eduman-prv/eduman/course.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Nov 2022 13:00:20 GMT -->
<head>
   <meta charset="utf-8">
               ...
               <div class="row align-items-center">
                  <div class="col-xl-8 col-lg-8">
                     <div class="header-top-icon">
                        ...
                        <a href="https://themepure.net/cdn-cgi/l/email-protection#30595e565f705548515d405c551e535f5d"><i class="fal fa-envelope"></i><span class="__cf_email__" data-cfemail="b2dbdcd4ddf2d7cad3dfc2ded79cd1dddf">[email&#160;protected]</span></a>
                              ...
                              <div class="course-info-wrapper">
                                 <div class="cart-info-body">
                                    <span class="category-color category-color-1"><a
                                          href="course.php">Development</a></span>
                              ...
                              <div class="course-info-wrapper">
                                 <div class="cart-info-body">
                                    <span class="category-color category-color-3"><a
                                          href="course.php">Business</a></span>
                                    <a href="course-details.html">
                     ...
                     <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="course-wrapper-2 mb-30">
                           ...
                           <div class="course-cart">
                              <div class="course-info-wrapper">
                                 <div class="cart-info-body">
                                    <span class="category-color category-color-2"><a href="course.php">Life
                                          Style</a></span>
                                    <a href="course-details.html">
                     ...
                     <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="course-wrapper-2 mb-30">
                           ...
                           <div class="student-course-footer">
                              ...
                              <div class="student-course-text">
                                 <h3><a href="course-details.html">Understanding Java Script 2022 Edition</a></h3>
                              </div>
                              <div class="portfolio-user">
                                 <div class="user-icon">
                                    <a href="instructor-profile.html"><i class="fas fa-user"></i>Danial</a>
                     ...
                     <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="course-wrapper-2 mb-30">
                           ...
                           <div class="student-course-footer">
                              ...
                              <div class="student-course-text">
                                 <h3><a href="course-details.html">Python for Financial Analysis and Algorithmic
                                       Trading</a></h3>
                              </div>
                              <div class="portfolio-user">
                                 <div class="user-icon">
                     ...
                     <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="course-wrapper-2 mb-30">
                           ...
                           <div class="student-course-footer">
                              ...
                              <div class="student-course-text">
                                 <h3><a href="course-details.html">Spring & Hibernate for Beginners Spring Social
                                       Boot</a></h3>
                              </div>
                              <div class="portfolio-user">
                                 <div class="user-icon">
                     ...
                     <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="course-wrapper-2 mb-30">
                           ...
                           <div class="student-course-footer">
                              ...
                              <div class="student-course-text">
                                 <h3><a href="course-details.html">Accounting Financial Total Beginners to Advanced</a>
                                 </h3>
                              </div>
                              <div class="portfolio-user">
                                 <div class="user-icon">
...
<!-- Mirrored from themepure.net/html/eduman-prv/eduman/course.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Nov 2022 13:00:24 GMT -->
</html>