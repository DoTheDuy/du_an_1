...
<!-- Mirrored from themepure.net/html/eduman-prv/eduman/cart.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Nov 2022 13:00:45 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-8 col-lg-8">
                        <div class="header-top-icon">
                            ...
                            <a href="https://themepure.net/cdn-cgi/l/email-protection#9bf2f5fdf4dbfee3faf6ebf7feb5f8f4f6"><i class="fal fa-envelope"></i><span class="__cf_email__" data-cfemail="50393e363f103528313d203c357e333f3d">[email&#160;protected]</span></a>
                                        ...
                                        <div class="dropdown-category">
                                            <nav>
                                                <ul>
                                                    ...
                                                    <li class="item-has-children"><a href="course.php">Art &
                                                            Design</a>
                                                        <!-- <ul class="category-submenu">
                                                    ...
                                                    <li class="item-has-children"><a href="course.php">Health &
                                                            Fitness</a>
                                                        <!-- <ul class="category-submenu">
                                            ...
                                            <li class="menu-item-has-children"><a href="#!">Pages</a>
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="menu-item-has-children"><a
                                                            href="instructor.php">instructor</a>
                                                        <!-- <ul class="sub-menu">
                                                            <li><a href="instructor.php">instructor</a></li>
                                                            <li><a href="instructor-profile.html">instructor profile</a>
                                                            </li>
                                                            <li><a href="become-instructor.php">become instructor</a>
                                                            </li>
                                                        </ul> -->
                                                    </li>
                                                    <li class="menu-item-has-children"><a href="zoom-class.php">zoom
                                                            class</a>
                                                        <!-- <ul class="sub-menu">
                                                            <li><a href="zoom-class.php">zoom class</a></li>
                                                            <li><a href="zoom-class-detalis.html">zoom class details</a>
                                                            </li>
                                                        </ul> -->
                                                    </li>
                                                    ...
                                                    <li class="menu-item-has-children"><a href="faq-page.html">FAQ
                                                            page</a>
                                                        <ul class="sub-menu">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                            <div class="footer-widget f-w1 mb-40">
                                <div class="footer-img">
                                    <a href="layout.php"> <img src="assets/img/logo/footer-logo.png"
                                            alt="footer-logo"></a>
