               ...
               <div class="col-xl-4 col-lg-4 col-md-6 grid-item c-2">
                  <div class="eduman-course-main-wrapper mb-30">
                     ...
                     <div class="eduman-course-thumb w-img">
                        <a href="/du_an_1?act=course_detail&idPro=<?php echo $value['ma_khoa_hoc'];?>"><img src="Views/images/<?php echo $value['hinh']?>"
                              alt="course-img"></a>
                     </div>
                     <div class="eduman-course-wraper">
                        ...
                        <div class="eduman-course-text">
                           <h3><a href="/du_an_1?act=course_detail&idPro=<?php echo $value['ma_khoa_hoc'];?>"><?php echo $value['ten_khoa_hoc']; ?></a>
                           </h3>
                        </div>
                        <div class="eduman-course-meta">
                           <div class="eduman-course-price">
                              <span class="price-now">$<?php echo $value['gia_khuyen_mai']; ?> </span>
                              <del class="price-old">$<?php echo $value['don_gia']; ?></del>
                           </div>
                     ...
                     <div class="eduman-course-footer">
                        ...
                        <div class="course-deteals-btn">
                           <a href="/du_an_1?act=course_detail&idPro=<?php echo $value['ma_khoa_hoc'];?><span class="me-2">View Details</span><i
