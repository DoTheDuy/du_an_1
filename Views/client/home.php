            ...
            <div class="row">
               <div class="col-xl-6 col-lg-6 col-md-6">
                  <div class="hero-text pt-95">
                     ...
                     <div class="hero-btn">
                        <a class="edu-btn" href="course.php">View all course</a>
                     </div>
                  </div>
               </div>
               <div class="col-xl-6 col-lg-6 col-md-6">
                  <div class="hero-right position-relative">
                     ...
                     <div class="shape-5">
                        <div class="course-card">
                           <img src="Views/client/assets/img/shape/slider-card-1.png" alt="image not found">
                           <img src="Views/client/assets/img/shape/slider-card-2.png" alt="image not found">
                           <img src="Views/client/assets/img/shape/slider-card-3.png" alt="image not found">
                           <img src="Views/client/assets/img/shape/slider-card-4.png" alt="image not found">
...
<!--      </div>-->
      ...
      <section class="course-area p-relative pt-110 pb-90">
         <div class="course-shape-1">
            <img src="Views/client/assets/img/shape/portfolio-shap-1.png" alt="shape">
         </div>
         <div class="course-shape-2">
            <img src="Views/client/assets/img/shape/portfolio-shap-2.png" alt="shape">
         </div>
         <div class="course-shape-3">
            <img src="Views/client/assets/img/shape/portfolio-shap-3.png" alt="shape">
         </div>
         <div class="container">
            <div class="row">
...
<!--                              <span class="category-color category-color-1"><a href="course.php">Development</a></span>-->
...
<!--                     </div>-->
                     ...
                     <div class="eduman-course-wraper">
                        ...
                        <div class="eduman-course-meta">
                           ...
                           <div class="eduman-course-tutor"><img src="Views/client/assets/img/portfilo/course-tutor-01.png"
                                 alt="image not found">
               ...
               <div class="col-xl-4 col-lg-4 col-md-6 grid-item c-2">
                  <div class="eduman-course-main-wrapper mb-30">
                     ...
                     <div class="eduman-course-thumb w-img">
                        <a href="course-details.html"><img src="Views/client/assets/img/portfilo/course-img-02.jpg"
                              alt="course-img"></a>
                     </div>
                     <div class="eduman-course-wraper">
                        <div class="eduman-course-heading">
                        ...
                        <div class="eduman-course-meta">
                           ...
                           <div class="eduman-course-tutor">
                              <img src="Views/client/assets/img/portfilo/course-tutor-02.png" alt="image not found">
               ...
               <div class="col-xl-4 col-lg-4 col-md-6 grid-item c-3">
                  <div class="eduman-course-main-wrapper mb-30">
                     <div class="course-cart">
                        <div class="course-info-wrapper">
                           <div class="cart-info-body">
                              <span class="category-color category-color-3"><a href="course.php">Business</a></span>
                              <a href="course-details.html">
                     ...
                     <div class="eduman-course-wraper">
                        <div class="eduman-course-heading">
                           <a href="course.php" class="course-link-color-3">Business</a>
                           <span class="couse-star"><i class="fas fa-star"></i>4.9 (25)</span>
                        </div>
                        <div class="eduman-course-text">
               ...
               <div class="col-xl-4 col-lg-4 col-md-6 grid-item c-1">
                  <div class="eduman-course-main-wrapper mb-30">
                     <div class="course-cart">
                        <div class="course-info-wrapper">
                           <div class="cart-info-body">
                              <span class="category-color category-color-5"><a href="course.pph">Data
                                    Science</a></span>
                              <a href="course-details.html">
                     ...
                     <div class="eduman-course-wraper">
                        <div class="eduman-course-heading">
                           <a href="course.php" class="course-link-color-5">Data Science</a>
                           <span class="couse-star"><i class="fas fa-star"></i>4.9 (25)</span>
                        </div>
                        <div class="eduman-course-text">
                        ...
                        <div class="eduman-course-meta">
                           ...
                           <div class="eduman-course-tutor">
                              <img src="Views/client/assets/img/portfilo/course-tutor-06.png" alt="image not found">
                              <a href="instructor-profile.html"><span>Mark Hanry</span></a>
                           </div>
                        </div>
                     </div>
               ...
               <div class="col-xl-4 col-lg-4 col-md-6 grid-item c-4">
                  <div class="eduman-course-main-wrapper mb-30">
                     <div class="course-cart">
                        <div class="course-info-wrapper">
                           <div class="cart-info-body">
                              <span class="category-color category-color-4"><a href="course.php">Life Style</a></span>
                              <a href="course-details.html">
                     ...
                     <div class="eduman-course-thumb w-img">
                        <a href="course-details.html"><img src="Views/client/assets/img/portfilo/course-img-04.jpg"
                              alt="course-img"></a>
                     </div>
                     <div class="eduman-course-wraper">
                        <div class="eduman-course-heading">
                           <a href="course.php" class="course-link-color-4">Life Style</a>
                           <span class="couse-star"><i class="fas fa-star"></i>4.9 (25)</span>
                        </div>
                        <div class="eduman-course-text">
                        ...
                        <div class="eduman-course-meta">
                           ...
                           <div class="eduman-course-tutor">
                              <img src="Views/client/assets/img/portfilo/course-tutor-04.png" alt="image not found">
                              <a href="instructor-profile.html"><span>Danial</span></a>
                           </div>
                        </div>
                     </div>
               ...
               <div class="swiper-wrapper">
                     ...
                     <div class="testimonial-items position-relative">
                        <div class="testimonial-header">
                           <div class="testimonial-img">
                              <img src="Views/client/assets/img/testimonial/Image.png" alt="image not found">
                           </div>
                        ...
                        <div class="testimoni-quotes">
                           <img src="Views/client/assets/img/testimonial/quotes.png" alt="image not found">
                  ...
                  <div class="swiper-slide">
                     <div class="testimonial-items position-relative">
                        <div class="testimonial-header">
                           <div class="testimonial-img">
                              <img src="Views/client/assets/img/testimonial/testimonial-02.png" alt="image not found">
                           </div>
                           <div class="testimonial-title">
                              <h4>Brandon Tylor</h4>
                              <span>Student</span>
                  ...
                  <div class="swiper-slide">
                     <div class="testimonial-items position-relative">
                        <div class="testimonial-header">
                           <div class="testimonial-img">
                              <img src="Views/client/assets/img/testimonial/testimonial.png" alt="image not found">
                           </div>
                           <div class="testimonial-title">
         ...
         <div class="container">
            <div class="row">
               <div class="col-xl-6 col-lg-6 col-md-12 mb-30">
                  <div class="browser-course-wrapper course-height" data-background="">
                     <div class="browser-course-bg">
                        <img src="Views/client/assets/img/browser-course/browser-course-01.jpg" alt="image not found">
                     </div>
                     <div class="browser-course-content">
                        <span>Start from today</span>
                        <div class="browser-course-tittle">
                           <a href="instructor.php">Become an instructor
               ...
               <div class="col-xl-6 col-lg-6 col-md-12 mb-30">
                  <div class="browser-course-wrapper course-height" data-background="">
                     <div class="browser-course-bg">
                        <img src="Views/client/assets/img/browser-course/browser-course-02.jpg" alt="image not found">
                     </div>
                     <div class="row">
                        <div class="col-xl-7 col-lg-7">
                           <div class="browser-course-content">
                              ...
                              <div class="browser-btn">
                                 <a class="course-btn" href="course.php">Browse courses</a>
                              </div>
                           </div>
                        </div>
                     </div>
      ...
      <section class="education-area position-relative pt-85">
         <div class="container">
            <img class="education-shape-2" src="Views/client/assets/img/shape/education-shape-04.png" alt="shape">
            <img class="education-shape-3" src="Views/client/assets/img/shape/education-shape-01.png" alt="shape">
            <img class="education-shape-4" src="Views/client/assets/img/shape/education-shape-03.png" alt="shape">
            <div class="row">
               <div class="col-xl-4 col-lg-4 offset-xl-2 offset-lg-2">
                  <div class="education-img mb-30">
                     <img src="Views/client/assets/img/teacher/education.png" alt="image not found">
                  </div>
               </div>
                           ...
                           <div class="swiper-wrapper">
                              ...
                              <div class="swiper-slide">
                                 <div class="singel-brand">
                                    <img src="Views/client/assets/img/brand/brand-01.png" alt="image not found">
                                 </div>
                              </div>
                              <div class="swiper-slide">
                                 <div class="singel-brand">
                                    <img src="Views/client/assets/img/brand/brand-02.png" alt="image not found">
                                 </div>
                              </div>
                              <div class="swiper-slide">
                                 <div class="singel-brand">
                                    <img src="Views/client/assets/img/brand/brand-03.png" alt="image not found">
                                 </div>
                              </div>
                              <div class="swiper-slide">
                                 <div class="singel-brand">
                                    <img src="Views/client/assets/img/brand/brand-04.png" alt="image not found">
                                 </div>
                              </div>
                              <div class="swiper-slide">
                                 <div class="singel-brand">
                                    <img src="Views/client/assets/img/brand/brand-05.png" alt="image not found">
                                 </div>
                              </div>
                              <div class="swiper-slide">
                                 <div class="singel-brand">
                                    <img src="Views/client/assets/img/brand/brand-06.png" alt="image not found">
                                 </div>
                              </div>
                           </div>
                        </div>
